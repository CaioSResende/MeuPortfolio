...
const dockerfile = (l: Lang): Line[] => [
  ...
  [tk("COPY ", VS.syn_keyword), tk("./certs/aws-developer-associate  ", VS.syn_string), tk("/badges/", VS.syn_string)],
...
const readmeMD = (l: Lang): Line[] => [
  ...
  [tk("- ✅ ", VS.syn_operator), tk("AWS Certified Developer – Associate",            VS.syn_string)],
