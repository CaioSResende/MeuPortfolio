...
const MenuBar = ({ scale }: MenuBarProps) => {
  ...
  return (
    <header
      className="fixed top-0 left-0 z-50 h-7 mac-menubar-glass flex items-center justify-between px-4 text-foreground/90 text-[13px] font-medium"
      style={{ width: `${100 / scale}vw`, transform: `scale(${scale})`, transformOrigin: "top left" }}
    >
